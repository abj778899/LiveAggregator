...
struct ContentView: View {
    ...
    let platforms: [Platform] = [
        ...
        Platform(name: "虎牙直播", url: "https://www.huya.com", icon: "🐯", bgColor: Color(red: 1.0, green: 0.85, blue: 0.0), textColor: .black),
        Platform(name: "斗鱼直播", url: "https://www.douyu.com", icon: "🐟", bgColor: Color(red: 1.0, green: 0.6, blue: 0.0), textColor: .white),
